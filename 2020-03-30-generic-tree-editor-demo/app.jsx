...
class App extends React.Component {
  ...
  render() {
    ...
    return <StorageContext.Provider value={this._contextValue}>
      <Route path="/2020-03-30-generic-tree-editor-demo/node/:path*" component={TreeEditor} />
...
setTimeout(() => {
  const app = <BrowserRouter>
    <Redirect path="/2020-03-30-generic-tree-editor-demo" to="/2020-03-30-generic-tree-editor-demo/node/demo/" />
    <Redirect path="/2020-03-30-generic-tree-editor-demo/node" to="/2020-03-30-generic-tree-editor-demo/node/demo/" />
    <Route path="/2020-03-30-generic-tree-editor-demo/" component={App} />
  </BrowserRouter>;
